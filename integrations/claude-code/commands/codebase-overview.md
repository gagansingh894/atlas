...
Follow the instructions in `skills/detect-git-changes.md`.
...
Follow the instructions in `skills/index-codebase.md`.
...
Follow the instructions in `skills/write-overview-doc.md`.
