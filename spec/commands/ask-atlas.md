...
Adjust the bracketed parts to reflect what was actually loaded.
...
2. **Do NOT re-explore the codebase.** No file searches or reads on source files not in `--files`. The docs are the source of truth.
